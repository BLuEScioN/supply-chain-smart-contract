...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferOne = await supplyChain.fetchItemBufferOne();
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo();
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        const result = supplyChain.purchaseItem(upc, { from: consumerID, value: productPrice });
        ...
        assert.equal(resultBufferTwo[8], consumerID, "Error: Invalid distributor.")
        assert.equal(resultBufferTwo[5], itemState, 'Error: Invalid item State')
